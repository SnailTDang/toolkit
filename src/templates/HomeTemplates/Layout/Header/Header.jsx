...
export default function Header(props) {
    ...
    let userHeader = isLogin
        ? JSON.parse(localStorage.getItem(USER_LOGIN)) || userLogin
        : null;
    useEffect(() => {}, []);
    return (
        <>
            <header className="pb-5 bg-blue-main bg-opacity-500/75 text-coolGray-100 w-100 z-10000 text-white sticky top-0">
                    ...
                    <div className="header-container container">
                        <div className="header-right">
                            <div className="header-phone text-right">
                                Hotline:{" "}
                                <a href="tel:02363630689">0236 3630 689</a>
                            </div>
                ...
                <div className="bg-strong-blue bg-opacity-500/75">
                    <div className="container flex justify-between mx-auto relative">
                        <a
                            href="/"
                            className="block w-fit items-center absolute -top-14 left-4 -bottom-4 bg-strong-blue bg-opacity-500/75"
                        >
                            <img
                                src={
                                    "https://snailtdang.github.io/cyberphone/img/Brandlogo.png"
                                }
                                alt=""
                                className="w-32"
                            />
                        ...
                        <ul className="items-stretch space-x-3 flex mb-0 ml-20 lg:ml-64">
                            <li className="flex">
                                <NavLink
                                    to="/"
                                    className={(isActive) =>
                                        isActiveMenu(isActive.isActive)
                                    }
                                >
                                    HOME
                                </NavLink>
